...
var (
	jobFields      = []string{"name", "description", "env", "env_file", "inherit_env", "workdir", "timeout", "expected_within", "max_concurrent", "max_parallel", "concurrency_key", "on_conflict", "shadow", "notify", "steps", "schedules", "sensors"}
